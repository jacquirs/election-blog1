...
knitr::opts_knit$set(root.dir = "C:/Users/Jacqui Schlesinger/Documents/election-blog1/Week 6")
...
lm(D_pv2p ~ log(contribution_receipt_amount) + factor(state), 
   data = d_campaign_spending) |> summary() # Why might this be? dataset skewed
