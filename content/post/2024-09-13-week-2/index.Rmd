...
Analyzing the fit of these two bivariate regressions, neither shows strong results or good in-sample fit. RDPI growth explains only 11.15% of the variance in incumbent popular vote share, while GDP growth fares slightly better at 32.48%. Despite being the top predictors in terms of in-sample fit, as shown below, their overall performance does not indicate strong predictive power. 

Additionally, the correlation between these predictors and the popular vote 1952-2016 is moderately strong and positive: 0.569918 for GDP growth and 0.3338966 for RDPI growth. However, correlation does not imply causation, and there is little evidence of a direct causal relationship between these economic indicators on their own and popular vote share. Additional omitted variables and multivariate relationships likely play a role that I cannot control for. Notably, the models perform worse with the 2020 outlier data.

A summary of the national economic variables used as predictors is shown below:
...
Evaluating these models indicates that none are particularly strong for incumbent popular vote models or significant in their ability to predict future values. All 13 regressions forecast Harris' popular vote percentage between 44.216% and 51.973%, but with 95% confidence intervals including 50%, indicating non-significant results. Additional factors are also needed to understand how Harris may fare given recent turmoil, a complication we cannot accurately reflect in bivariate cases. 

Among the models, Q2 GDP growth performs the best across all model evaluations, showing the highest in-sample fit, smallest root mean squared error, and smallest mean absolute error in out-of-sample cross-validation. The predictions for 2024 are also sensitive to predictor choice, suggesting that while economic fundamentals may influence incumbent vote share, there is not a direct bivariate relationship as the choice of predictor changes the model. This raises questions about whether economic fundamentals impact voting directly or indirectly and whether sociotropic or individual voting are more significant.
...
Note that each regression has only twelve data-points, likely leading to model overfitting. This issue also affects the national economic data with its slightly larger dataset. The limited number of elections makes it challenging to develop a model with strong out-of-sample performance.


### Individual Versus Sociotropic Voting Patterns
The results suggest that sociotropic voting, where people base their choices on national economic conditions affecting others, is a more likely explanation in the retrospective economic voting model than individual-based voting. This aligns with findings on the importance of national over states conditions.

As noted by [Achen and Bartels in "Democracy for Realists: Why Elections Do Not Produce Responsive Government"](https://muse-jhu-edu.ezp-prod1.hul.harvard.edu/book/64646), voters may be retrospective but focus on short-term economic behaviors to evaluate their choices, supporting the use of Q2 election-year metrics. [Scholars Lenz and Healy](https://www.journals.uchicago.edu/doi/abs/10.1086/692785) also point out that economic evaluations during election years may favor economic manipulators over true leaders, providing insight into manipulation of voter decision-making. 

It is also important to consider how voter behaviors may have changed over the period. Voters may have shifted away from retrospective behavior because of party polarization. Evidence from [Dassoneville and Tien's "Introduction to Forecasting the 2020 US Elections"](https://www.cambridge.org/core/journals/ps-political-science-and-politics/article/abs/introduction-to-forecasting-the-2020-us-elections/78235400F6BB7E2E370214D1A2307028) highlights that such changes and shocks to economic variables may throw off predictions.
...
### Data Sources
- Popular Vote by Candidate and State, 1948-2020
