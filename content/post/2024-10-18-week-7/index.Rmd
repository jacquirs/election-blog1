...
Because these models were made up to six weeks ago, the polling inputs have changed, particularly in those that use most recent polling data and average poll numbers. The models that I can update with new polling data include XXXXX. This helps determine if my eventual preferred model still holds up or if adjustments are necessary to account for new information.
...
# Render tables side by side using HTML tags
htmltools::tagList(
  htmltools::tags$table(
    htmltools::tags$tr(
      htmltools::tags$td(kable_prev),
      htmltools::tags$td(kable_new)
    )
  )
)
