...
# Evaluate the in-sample fit of your preferred model for 2020 dropped versus not 
...
# additionaly ways to look at it
plot(reg_econ_2)
...
sqrt(mse) # helpful with outliers
```

```{r}
# Model Testing: Leave-One-Out validation
...
# do it many times to tune hyperparameters of the model
